...
namespace Inceptum.AppHosting.AppDiscovery
{
    internal class AssemblyTester : MarshalByRefObject
    {
        public HostedAppInfo Try(string assemblyFile)
        {
            ...
            return new HostedAppInfo(attr.Name, appType == null ? null : typeof(ApplicationHost<>).MakeGenericType(appType).FullName)
                       {
